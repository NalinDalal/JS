...
console.log("it can be logged/skimmed. Without the verifier it is worthless.");
console.log("Implicit flow (token in URL) is deprecated; auth-code + PKCE is the standard.");