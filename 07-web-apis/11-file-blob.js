...
// Revoke with URL.revokeObjectURL(url)

// --- File (extends Blob) ---
// File has: name, lastModified, size, type, webkitRelativePath
...
// downloadJSON({ hello: 'world' }) defined
